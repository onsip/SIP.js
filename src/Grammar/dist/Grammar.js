  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$bytecode = [
          ...
          peg$decode("!/\u0102\"\"1&3\u0103*G \"/\u0104\"\"1'3\u0105*; \"/\u0106\"\"1$3\u0107*/ \"/\u0108\"\"1%3\u0109*# \"76+& 4!6\u010A! %"),
          peg$decode("7\xA4*# \"7\x9F"),
          peg$decode("!/\u010B\"\"1(3\u010C+O$7<+E%/\u010D\"\"1(3\u010E*/ \"/\u010F\"\"1(3\u0110*# \"76+#%'#%$## X$\"# X\"# X"),
          ...
          peg$decode("/\u0113\"\"1$3\u0114*S \"/\u0115\"\"1%3\u0116*G \"/\u0117\"\"1%3\u0118*; \"/\u0119\"\"1%3\u011A*/ \"/\u011B\"\"1+3\u011C*# \"7\xAC"),
          peg$decode("/\u011D\"\"1'3\u011E*/ \"/\u011F\"\"1)3\u0120*# \"7\xAC"),
          peg$decode("76*# \"7\xAD"),
          peg$decode("!/\u0121\"\"1\"3\u0122+-$76+#%'\"%$\"# X\"# X"),
          peg$decode("7\xAC*# \"76"),
          ...
          peg$decode("!/\u0127\"\"1#3\u0128+<$7<+2%76+(%4#6\u0129#! %$## X$\"# X\"# X"),
          ...
          peg$decode("7\xBD"),
          peg$decode("!/\u012D\"\"1&3\u012E+s$7.+i%7\xC0+_% ]!7A+-$7\xC0+#%'\"%$\"# X\"# X,8&!7A+-$7\xC0+#%'\"%$\"# X\"# X\"+#%'$%$$# X$## X$\"# X\"# X*# \"7\xBE"),
          ...
          peg$decode("!/\u012F\"\"1%3\u0130+7$7<+-%7\xC2+#%'#%$## X$\"# X\"# X"),
          peg$decode("!7I+' 4!6\u0131!! %"),
          peg$decode("!/\u0132\"\"1&3\u0133+\xA5$7<+\x9B%7D+\x91%7\xC4+\x87% ]! ]7'+&$,#&7'\"\"\" X+-$7\xC4+#%'\"%$\"# X\"# X,G&! ]7'+&$,#&7'\"\"\" X+-$7\xC4+#%'\"%$\"# X\"# X\"+-%7E+#%'&%$&# X$%# X$$# X$## X$\"# X\"# X"),
          peg$decode("7t*# \"7w"),
          peg$decode("!/\u0134\"\"1%3\u0135+7$7<+-%7\xC6+#%'#%$## X$\"# X\"# X"),
          peg$decode("!7I+' 4!6\u0136!! %"),
          peg$decode("!/\u0137\"\"1&3\u0138+<$7<+2%7I+(%4#6\u0139#! %$## X$\"# X\"# X"),
          peg$decode("!/\u013A\"\"1%3\u013B+_$7<+U%!/\u013C\"\"1$3\u013D+& 4!6\u013E! %*4 \"!/\u013F\"\"1%3\u0140+& 4!6\u0141! %+#%'#%$## X$\"# X\"# X"),
          peg$decode("!/\u0142\"\"1)3\u0143+T$7<+J%/\u0144\"\"1#3\u0145*/ \"/\u0146\"\"1(3\u0147*# \"76+(%4#6\u0148#! %$## X$\"# X\"# X"),
          peg$decode("!/\u0149\"\"1#3\u014A+\x9E$7<+\x94%7D+\x8A%!7\xCB+k$ ]!.D\"\"2D3E+-$7\xCB+#%'\"%$\"# X\"# X,>&!.D\"\"2D3E+-$7\xCB+#%'\"%$\"# X\"# X\"+#%'\"%$\"# X\"# X+-%7E+#%'%%$%# X$$# X$## X$\"# X\"# X"),
          peg$decode("!/\u014B\"\"1(3\u014C*/ \"/\u014D\"\"1$3\u014E*# \"76+' 4!6\u014F!! %"),
          peg$decode("!76+_$ ]!7A+-$76+#%'\"%$\"# X\"# X,8&!7A+-$76+#%'\"%$\"# X\"# X\"+#%'\"%$\"# X\"# X"),
          ...
          peg$decode("!/\u0155\"\"1&3\u0156*; \"/\u0157\"\"1'3\u0158*/ \"/\u0159\"\"1*3\u015A*# \"76+& 4!6\u015B! %"),
          peg$decode("!/\u015C\"\"1&3\u015D+<$7<+2%7\xD9+(%4#6\u015E#! %$## X$\"# X\"# X*\x83 \"!/\xFA\"\"1'3\xFB+<$7<+2%7\x9D+(%4#6\u015F#! %$## X$\"# X\"# X*S \"!/\u0160\"\"1+3\u0161+<$7<+2%7\x9D+(%4#6\u0162#! %$## X$\"# X\"# X*# \"7\x9F"),
          peg$decode("/\u0163\"\"1+3\u0164*k \"/\u0165\"\"1)3\u0166*_ \"/\u0167\"\"1(3\u0168*S \"/\u0169\"\"1'3\u016A*G \"/\u016B\"\"1&3\u016C*; \"/\u016D\"\"1*3\u016E*/ \"/\u016F\"\"1)3\u0170*# \"76"),
          peg$decode("71*# \" \\"),
          peg$decode("!76+_$ ]!7A+-$76+#%'\"%$\"# X\"# X,8&!7A+-$76+#%'\"%$\"# X\"# X\"+#%'\"%$\"# X\"# X*# \" \\"),
          ...
          peg$decode("!/\u0172\"\"1#3\u0173+<$7<+2%7\xEC+(%4#6\u0174#! %$## X$\"# X\"# X"),
          peg$decode("!/\u0175\"\"1%3\u0176+<$7<+2%7T+(%4#6\u0177#! %$## X$\"# X\"# X"),
          peg$decode("!/\u0178\"\"1(3\u0179+B$7<+8%7\\*# \"7Y+(%4#6\u017A#! %$## X$\"# X\"# X"),
          peg$decode("!/\u017B\"\"1&3\u017C+<$7<+2%76+(%4#6\u017D#! %$## X$\"# X\"# X"),
          peg$decode("!/\u017E\"\"1%3\u017F+T$!7<+5$ ]7!,#&7!\"+#%'\"%$\"# X\"# X*# \" \\+'%4\"6\u0180\" %$\"# X\"# X"),
          peg$decode("!7\xE7+K$7;+A%76+7%7;+-%7\xE8+#%'%%$%# X$$# X$## X$\"# X\"# X"),
          peg$decode("!/\x98\"\"1#3\xDA*# \"76+' 4!6\u0181!! %"),
          peg$decode("!/\xB7\"\"1#3\u0182*G \"/\xB9\"\"1#3\u0183*; \"/\xBD\"\"1#3\u0184*/ \"/\xBB\"\"1$3\u0185*# \"76+' 4!6\u0186!! %"),
          peg$decode("!7\xEA+H$!7C+-$7\xEB+#%'\"%$\"# X\"# X*# \" \\+#%'\"%$\"# X\"# X"),
          peg$decode("!7U*) \"7\\*# \"7X+& 4!6\u0187! %"),
          peg$decode("!!7!*# \" \\+c$7!*# \" \\+S%7!*# \" \\+C%7!*# \" \\+3%7!*# \" \\+#%'%%$%# X$$# X$## X$\"# X\"# X+' 4!6\u0188!! %"),
          peg$decode("!!7!+C$7!*# \" \\+3%7!*# \" \\+#%'#%$## X$\"# X\"# X+' 4!6\u0189!! %"),
          peg$decode("7\xBD"),
          peg$decode("!76+7$70+-%7\xEF+#%'#%$## X$\"# X\"# X"),
          peg$decode(" ]72*) \"74*# \"7.,/&72*) \"74*# \"7.\""),
          peg$decode(" ]7%,#&7%\""),
          peg$decode("!7\xF2+=$.8\"\"2839+-%7\xF3+#%'#%$## X$\"# X\"# X"),
          peg$decode("!/\u018A\"\"1%3\u018B*) \"/\u018C\"\"1$3\u018D+' 4!6\u018E!! %"),
          peg$decode("!7\xF4+N$!.8\"\"2839+-$7^+#%'\"%$\"# X\"# X*# \" \\+#%'\"%$\"# X\"# X"),
          peg$decode("!7\\*) \"7X*# \"7\x82+' 4!6\u018F!! %"),
          peg$decode("! ]7\xF6*) \"7-*# \"7\xF7,/&7\xF6*) \"7-*# \"7\xF7\"+& 4!6\u0190! %"),
