  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$consts = [
          ...
          function(value, method) { return {value: value, method: method}; },
          function() { return parseInt(text()); },
          function(expires) {data = expires; return data; },
          function(event_type) {
          ...
          function(min_expires) {data = min_expires; return data; },
          function() {
                                try {
                                  data = new SIP.NameAddrHeader(data.uri, data.displayName, data.params);
                                } catch(e) {
          ...
          function(www_authenticate) {return data;},
          "stuns",
        ...
        peg$bytecode = [
          ...
          peg$decode("7\x90*# \"7r"),
          peg$decode("!7\x8F+P$7'+F%7s+<%7'+2%7\x84+(%4%6\xD7%!\"%$%# X$$# X$## X$\"# X\"# X"),
          peg$decode("7M*# \"7t"),
          peg$decode("!7+G$.8\"\"2839+7%7u*# \"7x+'%4#6\xD8# %$## X$\"# X\"# X"),
          peg$decode("!7v*# \"7w+N$!.6\"\"2637+-$7\x83+#%'\"%$\"# X\"# X*# \" \\+#%'\"%$\"# X\"# X"),
          peg$decode("!.\xD9\"\"2\xD93\xDA+=$7\x80+3%7w*# \" \\+#%'#%$## X$\"# X\"# X"),
          ...
          peg$decode("!7\"+\x8D$ ]7\"*G \"7!*A \".@\"\"2@3A*5 \".F\"\"2F3G*) \".J\"\"2J3K,M&7\"*G \"7!*A \".@\"\"2@3A*5 \".F\"\"2F3G*) \".J\"\"2J3K\"+'%4\"6\xDB\" %$\"# X\"# X"),
          ...
          peg$decode(" ]7y,#&7y\""),
          peg$decode("!/\x98\"\"1#3\xDC+y$.4\"\"2435+i% ]7!+&$,#&7!\"\"\" X+P%.J\"\"2J3K+@% ]7!+&$,#&7!\"\"\" X+'%4%6\xDD% %$%# X$$# X$## X$\"# X\"# X"),
          ...
          peg$decode(".\xF0\"\"2\xF03\xF1"),
          peg$decode("!7\x85*S \"7\x86*M \"7\x88*G \"7\x89*A \"7\x8A*; \"7\x8B*5 \"7\x8C*/ \"7\x8D*) \"7\x8E*# \"76+& 4!6\xF2! %"),
          peg$decode("!7\x84+O$7'+E%7\x91+;%7'+1%7\x93+'%4%6\xD8% %$%# X$$# X$## X$\"# X\"# X"),
          peg$decode("!7\x92+' 4!6\xF3!! %"),
          peg$decode("!7!+7$7!+-%7!+#%'#%$## X$\"# X\"# X"),
          peg$decode("! ]7**A \"7+*; \"7-*5 \"73*/ \"74*) \"7'*# \"7(,G&7**A \"7+*; \"7-*5 \"73*/ \"74*) \"7'*# \"7(\"+& 4!6\xF4! %"),
          peg$decode("!7\xB5+_$ ]!7A+-$7\xB5+#%'\"%$\"# X\"# X,8&!7A+-$7\xB5+#%'\"%$\"# X\"# X\"+#%'\"%$\"# X\"# X"),
          peg$decode("!79+R$!.:\"\"2:3;+-$79+#%'\"%$\"# X\"# X*# \" \\+'%4\"6\xF5\" %$\"# X\"# X"),
          peg$decode("!7:*j \"!7\x97+_$ ]!7A+-$7\x97+#%'\"%$\"# X\"# X,8&!7A+-$7\x97+#%'\"%$\"# X\"# X\"+#%'\"%$\"# X\"# X+& 4!6\xF6! %"),
          peg$decode("!7L*# \"7\x98+c$ ]!7B+-$7\x9A+#%'\"%$\"# X\"# X,8&!7B+-$7\x9A+#%'\"%$\"# X\"# X\"+'%4\"6\xF7\" %$\"# X\"# X"),
          peg$decode("!7\x99*# \" \\+A$7@+7%7M+-%7?+#%'$%$$# X$## X$\"# X\"# X"),
          peg$decode("!!76+_$ ]!7.+-$76+#%'\"%$\"# X\"# X,8&!7.+-$76+#%'\"%$\"# X\"# X\"+#%'\"%$\"# X\"# X*# \"7H+' 4!6\xF8!! %"),
          peg$decode("7\x9B*) \"7\x9C*# \"7\x9F"),
          peg$decode("!/\xF9\"\"1!3\xFA+<$7<+2%7\x9E+(%4#6\xFB#! %$## X$\"# X\"# X"),
          peg$decode("!/\xFC\"\"1'3\xFD+<$7<+2%7\x9D+(%4#6\xFE#! %$## X$\"# X\"# X"),
          peg$decode("! ]7!+&$,#&7!\"\"\" X+' 4!6\xFF!! %"),
          peg$decode("!.\u0100\"\"2\u01003\u0101+x$!.J\"\"2J3K+S$7!*# \" \\+C%7!*# \" \\+3%7!*# \" \\+#%'$%$$# X$## X$\"# X\"# X*# \" \\+'%4\"6\u0102\" %$\"# X\"# X"),
          peg$decode("!76+N$!7<+-$7\xA0+#%'\"%$\"# X\"# X*# \" \\+)%4\"6\u0103\"\"! %$\"# X\"# X"),
          peg$decode("76*) \"7T*# \"7H"),
          peg$decode("!7\xA2+_$ ]!7B+-$7\xA3+#%'\"%$\"# X\"# X,8&!7B+-$7\xA3+#%'\"%$\"# X\"# X\"+#%'\"%$\"# X\"# X"),
          peg$decode("/\u0104\"\"1&3\u0105*G \"/\u0106\"\"1'3\u0107*; \"/\u0108\"\"1$3\u0109*/ \"/\u010A\"\"1%3\u010B*# \"76"),
          ...
          peg$decode("76*# \"7H"),
          peg$decode("!7\xB2+=$7.+3%7\x8F+)%4#6\u0124#\"\" %$## X$\"# X\"# X"),
          ...
          peg$decode("!/\u0129\"\"1#3\u012A+<$7<+2%76+(%4#6\u012B#! %$## X$\"# X\"# X"),
          ...
          peg$decode("!7\xBD+' 4!6\u012F!! %"),
          peg$decode("!!/\u0130\"\"1&3\u0131+s$7.+i%7\xC0+_% ]!7A+-$7\xC0+#%'\"%$\"# X\"# X,8&!7A+-$7\xC0+#%'\"%$\"# X\"# X\"+#%'$%$$# X$## X$\"# X\"# X*# \"7\xBE+& 4!6\xD8! %"),
          ...
          peg$decode("!7L*# \"7\x98+c$ ]!7B+-$7\x9F+#%'\"%$\"# X\"# X,8&!7B+-$7\x9F+#%'\"%$\"# X\"# X\"+'%4\"6\u0156\" %$\"# X\"# X"),
          peg$decode("!76+_$ ]!7A+-$76+#%'\"%$\"# X\"# X,8&!7A+-$76+#%'\"%$\"# X\"# X\"+#%'\"%$\"# X\"# X"),
          ...
          peg$decode("!7\xD7+c$ ]!7B+-$7\xD8+#%'\"%$\"# X\"# X,8&!7B+-$7\xD8+#%'\"%$\"# X\"# X\"+'%4\"6\xD8\" %$\"# X\"# X"),
          peg$decode("!/\u0158\"\"1&3\u0159*; \"/\u015A\"\"1'3\u015B*/ \"/\u015C\"\"1*3\u015D*# \"76+& 4!6\u015E! %"),
          peg$decode("!/\u015F\"\"1&3\u0160+<$7<+2%7\xD9+(%4#6\u0161#! %$## X$\"# X\"# X*\x83 \"!/\xFC\"\"1'3\xFD+<$7<+2%7\x9D+(%4#6\u0162#! %$## X$\"# X\"# X*S \"!/\u0163\"\"1+3\u0164+<$7<+2%7\x9D+(%4#6\u0165#! %$## X$\"# X\"# X*# \"7\x9F"),
          ...
          peg$decode("7\xB8*# \"7\x9F"),
          peg$decode("!7\xDF+c$ ]!7A+-$7\xDF+#%'\"%$\"# X\"# X,8&!7A+-$7\xDF+#%'\"%$\"# X\"# X\"+'%4\"6\xD8\" %$\"# X\"# X"),
          ...
          peg$decode("!/\x98\"\"1#3\xDC*# \"76+' 4!6\u0184!! %"),
          peg$decode("!/\xB7\"\"1#3\u0185*G \"/\xB9\"\"1#3\u0186*; \"/\xBD\"\"1#3\u0187*/ \"/\xBB\"\"1$3\u0188*# \"76+' 4!6\u0189!! %"),
          ...
          peg$decode("!7\xBD+' 4!6\u018D!! %"),
          peg$decode("!76+7$70+-%7\xEF+#%'#%$## X$\"# X\"# X"),
          peg$decode(" ]72*) \"74*# \"7.,/&72*) \"74*# \"7.\""),
          peg$decode(" ]7%,#&7%\""),
          peg$decode("!7\xF2+A$.8\"\"2839+1%7\xF3+'%4#6\xD8# %$## X$\"# X\"# X"),
          peg$decode("!/\u018E\"\"1%3\u018F*) \"/\u0190\"\"1$3\u0191+' 4!6\u0192!! %"),
          peg$decode("!7\xF4+N$!.8\"\"2839+-$7^+#%'\"%$\"# X\"# X*# \" \\+#%'\"%$\"# X\"# X"),
          peg$decode("!7\\*) \"7X*# \"7\x82+' 4!6\u0193!! %"),
          peg$decode("! ]7\xF6*) \"7-*# \"7\xF7,/&7\xF6*) \"7-*# \"7\xF7\"+& 4!6\u0194! %"),
          ...
          peg$decode("!7\xF9+l$.8\"\"2839+\\%7\xF3+R%!.\u0195\"\"2\u01953\u0196+-$7\xE8+#%'\"%$\"# X\"# X*# \" \\+'%4$6\xD8$ %$$# X$## X$\"# X\"# X"),
          peg$decode("!/\u0197\"\"1%3\u0198*) \"/\u0199\"\"1$3\u019A+' 4!6\u0192!! %"),
          peg$decode("!7\xE8+Q$/\xB7\"\"1#3\xB8*7 \"/\xB9\"\"1#3\xBA*+ \" ]7+,#&7+\"+'%4\"6\u019B\" %$\"# X\"# X"),
          peg$decode("!.\u019C\"\"2\u019C3\u019D+-$7\xFC+#%'\"%$\"# X\"# X"),
          peg$decode("!7\xFE+\x90$.F\"\"2F3G+\x80%7\xFD+v%.F\"\"2F3G+f%7\xFD+\\%.F\"\"2F3G+L%7\xFD+B%.F\"\"2F3G+2%7\xFF+(%4)6\u019E)!(%$)# X$(# X$'# X$&# X$%# X$$# X$## X$\"# X\"# X"),
