...
(function (Exceptions) {
    ...
    var TransactionStateError = /** @class */ (function (_super) {
        __extends(TransactionStateError, _super);
    ...
    Exceptions.TransactionStateError = TransactionStateError;
    /**
    ...
    var ClosedSessionDescriptionHandlerError = /** @class */ (function (_super) {
        __extends(ClosedSessionDescriptionHandlerError, _super);
    ...
    var TerminatedSessionError = /** @class */ (function (_super) {
        __extends(TerminatedSessionError, _super);
    ...
    var UnsupportedSessionDescriptionContentTypeError = /** @class */ (function (_super) {
        __extends(UnsupportedSessionDescriptionContentTypeError, _super);
