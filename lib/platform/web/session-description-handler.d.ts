...
import { BodyAndContentType, Session, SessionDescriptionHandler as SessionDescriptionHandlerDefinition, SessionDescriptionHandlerModifier, SessionDescriptionHandlerOptions } from "../../api";
...
export declare class SessionDescriptionHandler extends EventEmitter implements SessionDescriptionHandlerDefinition {
     ...
     */
    getDescription(options?: WebSessionDescriptionHandlerOptions, modifiers?: Array<SessionDescriptionHandlerModifier>): Promise<BodyAndContentType>;
    /**
     ...
     */
    setDescription(sessionDescription: string, options?: WebSessionDescriptionHandlerOptions, modifiers?: Array<SessionDescriptionHandlerModifier>): Promise<void>;
    /**
