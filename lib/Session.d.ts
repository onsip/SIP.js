...
import { Body, IncomingAckRequest, IncomingInviteRequest, IncomingPrackRequest, IncomingRequest } from "./Core/messages";
import { Session as SessionCore } from "./Core/session";
import { InviteServerTransaction, NonInviteServerTransaction } from "./Core/transactions";
...
export declare abstract class Session extends EventEmitter {
    ...
    on(event: "progress", listener: (response: string, reasonPhrase?: any) => void): this;
