...
import { InviteClientTransaction, InviteServerTransaction, NonInviteClientTransaction, NonInviteServerTransaction, Transaction } from "./Transactions";
...
export declare class UA extends EventEmitter {
    ...
    transactions: {
        nist: {
            [id: string]: NonInviteServerTransaction | undefined;
        };
        nict: {
            [id: string]: NonInviteClientTransaction | undefined;
        };
        ist: {
            [id: string]: InviteServerTransaction | undefined;
        };
        ict: {
            [id: string]: InviteClientTransaction | undefined;
        };
    };
    sessions: {
    ...
    readonly nictTransactionsCount: number;
    readonly nistTransactionsCount: number;
    readonly ictTransactionsCount: number;
    readonly istTransactionsCount: number;
     ...
     */
    newTransaction(transaction: NonInviteClientTransaction | InviteClientTransaction | InviteServerTransaction | NonInviteServerTransaction): void;
    /**
     * destroy Transaction
     * @param {SIP.Transaction} transaction.
     */
    destroyTransaction(transaction: NonInviteClientTransaction | InviteClientTransaction | InviteServerTransaction | NonInviteServerTransaction): void;
    /**
    ...
    on(name: "newTransaction" | "transactionDestroyed", callback: (transaction: Transaction) => void): this;
