...
var InviteDialog = /** @class */ (function (_super) {
    __extends(InviteDialog, _super);
    function InviteDialog(initialTransaction, core, state, delegate) {
    ...
    InviteDialog.prototype.dispose = function () {
    ...
    Object.defineProperty(InviteDialog.prototype, "sessionState", {
    ...
    Object.defineProperty(InviteDialog.prototype, "signalingState", {
        /** The state of the offer/answer exchange. */
        get: function () {
    ...
    Object.defineProperty(InviteDialog.prototype, "offer", {
    ...
    Object.defineProperty(InviteDialog.prototype, "answer", {
    ...
    InviteDialog.prototype.confirm = function () {
    ...
    InviteDialog.prototype.reConfirm = function () {
        // When we're confirmed start the retransmitting whatever
        // the 2xx final response that may have confirmed us.
     ...
     */
    InviteDialog.prototype.ack = function (options) {
        ...
        var message = this.createOutgoingRequestMessage(Constants_1.C.ACK, options);
     ...
     */
    InviteDialog.prototype.bye = function (delegate, options) {
     ...
     */
    InviteDialog.prototype.info = function (delegate, options) {
     ...
     * @param options Options bucket
     */
    InviteDialog.prototype.invite = function (delegate, options) {
     ...
     * @param options Options bucket.
     */
    InviteDialog.prototype.notify = function (delegate, options) {
     ...
     * @param options Options bucket.
     */
    InviteDialog.prototype.prack = function (delegate, options) {
        if (options === void 0) { options = {}; }
     ...
     * @param options Options bucket.
     */
    InviteDialog.prototype.refer = function (delegate, options) {
        if (options === void 0) { options = {}; }
     ...
     */
    InviteDialog.prototype.receiveRequest = function (message) {
        ...
        if (message.method === Constants_1.C.ACK) {
        ...
        if (message.method === Constants_1.C.INVITE) {
            ...
            if (!(contact instanceof NameAddrHeader_1.NameAddrHeader)) {
    ...
    InviteDialog.prototype.reliableSequenceGuard = function (message) {
     ...
     */
    InviteDialog.prototype.signalingStateTransition = function (message) {
    ...
    InviteDialog.prototype.start2xxRetransmissionTimer = function () {
        var _this = this;
        if (this.initialTransaction instanceof transactions_1.InviteServerTransaction) {
    ...
    // FIXME: Refactor
    InviteDialog.prototype.startReInvite2xxRetransmissionTimer = function () {
        var _this = this;
...
exports.InviteDialog = InviteDialog;
