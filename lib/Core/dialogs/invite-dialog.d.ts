import { IncomingRequest as IncomingRequestMessage, IncomingResponse as IncomingResponseMessage, OutgoingRequest as OutgoingRequestMessage } from "../../SIPMessage";
import { Body, OutgoingAckRequest, OutgoingByeRequest, OutgoingInfoRequest, OutgoingInviteRequest, OutgoingInviteRequestDelegate, OutgoingNotifyRequest, OutgoingPrackRequest, OutgoingReferRequest, OutgoingRequestDelegate, RequestOptions } from "../messages";
...
export declare class InviteDialog extends Dialog implements Session {
     ...
     */
    signalingStateTransition(message: IncomingRequestMessage | IncomingResponseMessage | OutgoingRequestMessage | OutgoingResponseBody): void;
