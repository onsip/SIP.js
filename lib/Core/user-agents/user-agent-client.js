...
var UserAgentClient = /** @class */ (function () {
    ...
    UserAgentClient.prototype.cancel = function (reason, options) {
        ...
        // https://tools.ietf.org/html/rfc3261#section-9.1
        var message = new SIPMessage_1.OutgoingRequest(Constants_1.C.CANCEL, this.message.ruri, this.message.ua, {
    ...
    UserAgentClient.prototype.onRequestTimeout = function () {
        ...
        var message = this.core.configuration.onRequestTimeoutResponseMessageFactory();
    ...
    UserAgentClient.prototype.onTransportError = function (error) {
        ...
        var message = this.core.configuration.onTransportErrorResponseMessageFactory();
        this.receiveResponse(message);
    };
