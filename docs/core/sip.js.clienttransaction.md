...
|  --- | --- | --- |
|  [(constructor)(\_request, transport, user, state, loggerCategory)](./sip.js.clienttransaction.(constructor).md) |  | Constructs a new instance of the <code>ClientTransaction</code> class |
